...
RSpec.describe Sys::ProcTable, :aix do
  ...
  context 'ProcTable::Struct members' do
    ...
    it 'contains a euid member and returns the expected value' do
      ...
      expect(@p1info.euid).to be_a(Integer)
    ...
    it 'contains a gid member and returns the expected value' do
      ...
      expect(@p1info.gid).to be_a(Integer)
    ...
    it 'contains a egid member and returns the expected value' do
      ...
      expect(@p1info.egid).to be_a(Integer)
    ...
    it 'contains a pgid member and returns the expected value' do
      ...
      expect(@p1info.pgid).to be_a(Integer)
  ...
  context 'Struct::ProcTableMapStruct' do
    ...
    it 'has members of the expected type' do
      ...
      expect(p1info_map).to be_a(Struct::ProcTableMapStruct)
      expect(p1info_map.size).to be_a(Integer)
      expect(p1info_map.vaddr).to be_a(Integer)
      expect(p1info_map.mapname).to be_a(String)
      expect(p1info_map.off).to be_a(Integer)
      expect(p1info_map.mflags).to be_a(Integer)
      expect(p1info_map.s_mflags).to be_a(String)
      expect(p1info_map.pathoff).to be_a(Integer)
      expect(p1info_map.alias).to be_a(Integer)
      expect(p1info_map.gp).to be_a(Integer)
      expect(p1info_map.path).to be_a(String)
    end
  end
end
